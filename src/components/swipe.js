...
import coinsshadow from '../img/coinsshadow.svg';
import swiperightwhite from '../img/swiperightwhite.svg';
import darelogowhite from '../img/darelogowhite.svg';
import coinsdropshadow from '../img/coinsdropshadow.svg';
import '../App.css';
...
return (
      <Slider {...settings} className="swipeContent">
        ...
        <div className="swipeDiv">
          ...
          <p className="swipeText">Swipe right to read more about <span className="swipeSpanText">DARE.</span> <br></br> Or just log in straight away!</p>
        </div >
